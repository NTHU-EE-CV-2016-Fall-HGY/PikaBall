...
if __name__ == '__main__':
    ...
    while not done:
        ...
        if e.type == pygame.QUIT:
            ...
            for index, data in enumerate(skeletons):
                # draw the Head
                #print index, data.SkeletonPositions[JointId.HandLeft].y, data.SkeletonPositions[JointId.HandRight].y, data.SkeletonPositions[JointId.Spine].z, data.SkeletonPositions[JointId.ShoulderCenter].y
