...
if __name__ == '__main__':
    ...
    while True:
        ...
        if skeleton.frame.visible:
            ...
            if (right_hand.y > spine.y) and (left_hand.y > spine.y):
                raised = True
                print('Recognized YOOOOOOOOO.')
            elif left_hand.y > spine.y:
                raised = True
                print('Recognized left hand wave.')
            elif right_hand.y > spine.y:
                raised = True
